    ...
    <div className="min-h-screen bg-background">
      ...
      {(pulling || refreshing) && (
        <div
          ...
          style={{ transform: `translateY(${Math.min(pullDistance - 20, 40)}px)`, opacity: pullDistance / threshold }}
        >
          <div className={cn(
            "w-9 h-9 rounded-full bg-secondary/90 backdrop-blur-md border border-border flex items-center justify-center shadow-lg",
            refreshing && "animate-spin"
          )}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              className={cn("text-primary transition-transform", pullDistance >= threshold && !refreshing && "rotate-180")}
            >
